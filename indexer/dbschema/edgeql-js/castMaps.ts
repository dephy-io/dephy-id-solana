...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$DeviceSigningAlgorithm ? _default.$DeviceSigningAlgorithm : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _default.$DeviceSigningAlgorithm ?
    B extends _default.$DeviceSigningAlgorithm ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::DeviceSigningAlgorithm") {
    if(b.__name__ === "default::DeviceSigningAlgorithm") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
