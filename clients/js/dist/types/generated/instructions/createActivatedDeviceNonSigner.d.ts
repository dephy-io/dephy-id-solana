...
export declare function getCreateActivatedDeviceNonSignerInstructionDataEncoder(): Encoder<CreateActivatedDeviceNonSignerInstructionDataArgs>;
export declare function getCreateActivatedDeviceNonSignerInstructionDataDecoder(): Decoder<CreateActivatedDeviceNonSignerInstructionData>;
export declare function getCreateActivatedDeviceNonSignerInstructionDataCodec(): Codec<CreateActivatedDeviceNonSignerInstructionDataArgs, CreateActivatedDeviceNonSignerInstructionData>;
...
export declare function getCreateActivatedDeviceNonSignerInstruction<TAccountSystemProgram extends string, TAccountToken2022Program extends string, TAccountAtaProgram extends string, TAccountPayer extends string, TAccountVendor extends string, TAccountProductMint extends string, TAccountProductAssociatedToken extends string, TAccountDevice extends string, TAccountDeviceMint extends string, TAccountDeviceAssociatedToken extends string, TAccountOwner extends string, TProgramAddress extends Address = typeof DEPHY_ID_PROGRAM_ADDRESS>(input: CreateActivatedDeviceNonSignerInput<TAccountSystemProgram, TAccountToken2022Program, TAccountAtaProgram, TAccountPayer, TAccountVendor, TAccountProductMint, TAccountProductAssociatedToken, TAccountDevice, TAccountDeviceMint, TAccountDeviceAssociatedToken, TAccountOwner>, config?: {
    programAddress?: TProgramAddress;
}): CreateActivatedDeviceNonSignerInstruction<TProgramAddress, TAccountSystemProgram, TAccountToken2022Program, TAccountAtaProgram, TAccountPayer, TAccountVendor, TAccountProductMint, TAccountProductAssociatedToken, TAccountDevice, TAccountDeviceMint, TAccountDeviceAssociatedToken, TAccountOwner>;
export type ParsedCreateActivatedDeviceNonSignerInstruction<TProgram extends string = typeof DEPHY_ID_PROGRAM_ADDRESS, TAccountMetas extends readonly IAccountMeta[] = readonly IAccountMeta[]> = {
...
export declare function parseCreateActivatedDeviceNonSignerInstruction<TProgram extends string, TAccountMetas extends readonly IAccountMeta[]>(instruction: IInstruction<TProgram> & IInstructionWithAccounts<TAccountMetas> & IInstructionWithData<Uint8Array>): ParsedCreateActivatedDeviceNonSignerInstruction<TProgram, TAccountMetas>;
//# sourceMappingURL=createActivatedDeviceNonSigner.d.ts.map