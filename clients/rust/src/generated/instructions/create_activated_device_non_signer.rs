...
use crate::generated::types::CreateActivatedDeviceArgs;
...
pub struct CreateActivatedDeviceNonSignerBuilder {
    ...
    create_activated_device_args: Option<CreateActivatedDeviceArgs>,
...
impl CreateActivatedDeviceNonSignerBuilder {
    ...
    #[inline(always)]
    pub fn create_activated_device_args(
        &mut self,
        create_activated_device_args: CreateActivatedDeviceArgs,
    ) -> &mut Self {
        self.create_activated_device_args = Some(create_activated_device_args);
        self
    }
...
impl<'a, 'b> CreateActivatedDeviceNonSignerCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateActivatedDeviceNonSignerCpiBuilderInstruction {
            ...
            owner: None,
            create_activated_device_args: None,
    ...
    pub fn create_activated_device_args(
        ...
        self.instruction.create_activated_device_args = Some(create_activated_device_args);
        self
    }
